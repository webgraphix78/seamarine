	...
	<div id="app">
		<nav class="navbar fixed-top navbar-expand-md navbar-light bg-dark shadow-sm">
			<div class="container-fluid">
				...
				<button class="btn btn-outline-light d-flex d-block d-sm-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebarMenu" aria-controls="sidebarMenu"><i class="ph ph-list"></i></button>
		...
		<main>
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-12 col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-4 pb-2">
						@yield('content')
					</div>
				</div>
			</div>
