<template>
	<div id="onhire-add-main">
		...
		<div class="row mb-4">
			...
			<div class="col-md-3" v-if="document1.contents && document1.contents.length > 0">
		...
		<div class="row mb-4">
			...
			<div class="col-md-3" v-if="document2.contents && document2.contents.length > 0">
		...
		<div class="row mb-5">
			<div class="col-md-3">
				<button type="button" class="btn btn-dark btn-sm w-100" @click="saveOnhire()">SAVE CHANGES</button>
			</div>
		</div>
	</div>
</template>
