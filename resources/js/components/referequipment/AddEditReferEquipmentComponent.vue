		...
		<div class="row mb-1" v-if="!isModal">
			<div class="col-sm-7">
				<div class="d-flex align-items-center mb-2">
					...
					<h4 class="m-0 text-capitalize">Add refer equipment</h4>
				</div>
			</div>
		</div>
		...
		<div class="row mb-4  align-items-center">
			...
			<div class="col-md-6">
				<div class='row gy-4 align-items-center'>
					...
					<div class="col-md-6">
						<label for="add_referequipment_refg_run_through" class="form-label text-uppercase m-0">Plugged in to Power Supply , run through & Temperature  set ⁰ C checked</label>
					</div>
					<div class="col-md-6 mb-3 mb-md-0">
...
export default {
	...
	methods: {
		...
		async saveReferEquipment(event){
			...
			console.log(that.referequipmentFormObj.container_type);
			...
			that.referequipmentFormObj.container_type = that.referequipmentFormObj.container_type.id;
			}
	...
	async mounted() {
		...
		if (this.referequipmentFormObj.container_type != null) {
			if (Array.isArray(this.allContainerTypeList) && this.allContainerTypeList.length > 0) {
				this.referequipmentFormObj.container_type = this.allContainerTypeList.find(item => item.id == this.referequipmentFormObj.container_type);
			}
		}
	}
}
